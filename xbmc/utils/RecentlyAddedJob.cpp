...
bool CRecentlyAddedJob::UpdateVideo()
{
  ...
  for (; i < NUM_ITEMS; ++i)
  {
    ...
    home->SetProperty("LatestMovie." + value + ".UserRating"  , "");
  ...
  if (videodatabase.GetRecentlyAddedEpisodesNav("videodb://recentlyaddedepisodes/", TVShowItems, NUM_ITEMS))
  {
    for (; i < TVShowItems.Size(); ++i)
    {
      ...
      home->SetProperty("LatestEpisode." + value + ".UserRating"    , strUserRating);
  ...
  for (; i < NUM_ITEMS; ++i)
  {
    ...
    home->SetProperty("LatestEpisode." + value + ".UserRating"    , "");
